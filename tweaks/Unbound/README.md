...
6. To build a package, select the package scheme explicitly:
...
The resulting `.deb` files will be in the `packages` folder. Rootless packages use
`iphoneos-arm64`; roothide packages use `iphoneos-arm64e`.
